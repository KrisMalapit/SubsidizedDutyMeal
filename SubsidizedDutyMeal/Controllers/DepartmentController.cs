...
namespace SubsidizedDutyMeal.Controllers
{
    public class DepartmentController : Controller
    {
        ...
        public JsonResult Delete(int? id)
        {
            ...
            try
            {
                Department detail = db.Departments.Find(id);
            ...
            Log log = new Log();
            log.descriptions = "Delete Department Record. ID:" + id;
        ...
        public JsonResult SelectDepartment(string q)
        {

            var model = db.Departments.Where(b=>b.Status=="Active").Select(b => new
            {
