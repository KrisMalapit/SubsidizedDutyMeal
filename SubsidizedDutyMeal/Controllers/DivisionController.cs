...
namespace SubsidizedDutyMeal.Controllers
{
    public class DivisionController : Controller
    {
        ...
        public JsonResult CreateUpdate(Division item, string Ttype)
        {
        ...
        public JsonResult Delete(int? id)
        {
            ...
            try
            {
                Division detail = db.Divisions.Find(id);
            ...
            Log log = new Log();
            log.descriptions = "Delete Division Record. ID:" + id;
        ...
        public JsonResult SelectDivision(string q)
        {

            var model = db.Divisions.Where(b => b.Status == "Active").Select(b => new
            {
